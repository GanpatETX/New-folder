          ...
          <div className="p-5 space-y-6">
            ...
            <div className="p-4 rounded-xl border border-border bg-card">
              ...
              <p className="text-xs text-muted-foreground mb-4">
                Provide a comprehensive job description for this position
              </p>
              ...
              <div className="flex items-center gap-2 mb-3">
                <button
                  type="button"
                  className="px-3 py-1.5 text-xs font-medium border border-border rounded-lg hover:bg-muted/20 transition-all"
                >
                  Use Existing JD Template
                </button>
                <button
                  type="button"
                  onClick={() =>
              ...
              <textarea
                ...
                placeholder={`Role Overview\n[Describe the role and its strategic importance]\n\nResponsibilities\n• [Key responsibility 1]\n• [Key responsibility 2]\n• [Key responsibility 3]\n\nRequired Qualifications\n• [Required qualification 1]\n• [Required qualification 2]\n• [Required qualification 3]\n\nPreferred Qualifications\n• [Preferred qualification 1]\n• [Preferred qualification 2]\n\nCompensation & Benefits\n[Compensation range and benefits]\n\nReporting Structure\n[Reporting relationships]\n\nAdditional Notes\n[Any additional information]`}
                rows={12}
                className="w-full px-3 py-2 text-sm bg-muted/30 border border-border rounded-lg focus:outline-none focus:ring-1 focus:ring-foreground/20 resize-none placeholder:text-muted-foreground/50 font-mono"
              />

              {/* Optional JD File Upload */}
              <div className="mt-4">
                <label className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider mb-2 block">
                  Attach Existing JD (Optional)
                </label>
                <div
                  className="relative border-2 border-dashed border-border rounded-lg p-6 hover:border-foreground/20 transition-all cursor-pointer group"
                  onClick={() =>
                    document.getElementById("jd-upload")?.click()
                  }
                >
                      ...
                      <>
                        ...
                        <div className="text-center">
                          ...
                          <p className="text-xs text-muted-foreground mt-1">
                            {(formData.jdFile.size / 1024).toFixed(2)} KB
                          </p>
                        </div>
                        <button
                          type="button"
